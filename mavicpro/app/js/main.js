$(function () {
  const activeClass = 'questions__item--active'
  ...
  $('.products__slider').slick({
    ...
    <path d="M9.21839 1L1 9L9.21839 17" /></svg></button>`,
    ...
    <path d="M0.78161 17L9 9L0.78161 1" /></svg></button>`,
    infinite: false,
  })

  $('.questions__item-title').on('click', function () {
    $('.questions__item').removeClass(activeClass)
